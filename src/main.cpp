...
int64 nChainStartTime = 1452480600;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Jan 11, 2016, LiTerCoin start---Putin Signs Treaty To Add Crimea To Map.";
        CTransaction txNew;
        ...
        printf("block.nNonce = %u \n", block.nNonce);
			block.print();
        assert(block.hashMerkleRoot == uint256("0x825e15e82d021b850c2ba67b4019cadd62d6882044ec7058d1534a8c75476151"));
